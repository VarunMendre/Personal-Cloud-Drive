...
export default function SubscriptionAlert({ 
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
      ...
      {/* Alert Container */}
      <div className="relative w-full max-w-2xl bg-[#FFF5F5] rounded-xl border-l-[6px] border-red-500 shadow-2xl overflow-hidden animate-in zoom-in-95 slide-in-from-bottom-4 duration-300">
        ...
        <div className="p-6 md:p-8 flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-grow">
            <h2 className="text-xl font-bold text-[#8B1A1A] mb-2 leading-tight">
              {title}
            </h2>
            <div className="text-[#8B1A1A]/80 text-sm md:text-[15px] leading-relaxed mb-6 font-medium">
              {message}
            </div>
